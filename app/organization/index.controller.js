    ...
    angular
        .module('app')
        .controller('Organization.IndexController', ['$scope', '$http', '$uibModal',
    ...
    function ($scope, $http, $uibModal) {
        ...
        //HTTP POST/PUT methods for add/edit organization
        ...
        $scope.openModal  = function(orgzanization){
            $uibModal.open({
        ...
        .controller('modalController', function ( $scope , $uibModalInstance ,$http ) {
